            ...
            GenderService.loadGenders()
                .then((res) => {
                    if (res.status === 200) {
                        ...
                        console.error("Unexpected status error while loading genders: ", res.status);
                    }
                })
                .catch((error) => {
            ...
            UserService.updateUser(state.user_id, state)
                .then((res) => {
                    if(res.status === 200) {
                        ...
                        console.error('Unexpected status error while updating user: ', res.status);
                    }
                })
                .catch((error) => {
                ...
                <div className="col-md-6">
                    ...
                    <div className="mb-3">
                        ...
                        {state.errors.contact_number && (
                            <span className="text-danger">{state.errors.contact_number[0]}</span>
                        )}
                    </div>
                    <div className="mb-3">
